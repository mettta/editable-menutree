...
pug_html = pug_html + "\n  \u003Cbutton" + (pug_attr("class", pug_classes([blockName + '__button',blockName + '__button_submit'], [true,true]), false, false)) + "\u003E";
;pug_debug_line = 8;pug_debug_filename = "src\u002Fcomponents\u002Fform\u002Fform.pug";
