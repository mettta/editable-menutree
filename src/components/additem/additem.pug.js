...
var pug_match_html=/["&<>]/;
function pug_rethrow(n,e,r,t){if(!(n instanceof Error))throw n;if(!("undefined"==typeof window&&e||t))throw n.message+=" on line "+r,n;try{t=t||require("fs").readFileSync(e,"utf8")}catch(e){pug_rethrow(n,null,r)}var i=3,a=t.split("\n"),o=Math.max(r-i,0),h=Math.min(a.length,r+i),i=a.slice(o,h).map(function(n,e){var t=e+o+1;return(t==r?"  > ":"    ")+t+"| "+n}).join("\n");throw n.path=e,n.message=(e||"Pug")+":"+r+"\n"+i+"\n\n"+n.message,n}function additemTemplate(locals) {var pug_html = "", pug_mixins = {}, pug_interp;var pug_debug_filename, pug_debug_line;try {var pug_debug_sources = {"src\u002Fcomponents\u002Fadditem\u002Fadditem.pug":"div(class= blockName + '__form')\n\tp Добавить элемент\n\t\tif targetTitle\n\t\t\tmark в&nbsp; \n\t\t\t\ti= targetTitle + ': '\n\tinput(type=\"text\" name=\"name\" placeholder=\"Название\" value=\"\")\n\tinput(type=\"text\" name=\"url\" placeholder=\"http:\u002F\u002F..\" value=\"\")\n\tbutton(class= blockName + '__submit') добавить\n"};
;var locals_for_with = (locals || {});(function (blockName, targetTitle) {var pug_indent = [];
;pug_debug_line = 1;pug_debug_filename = "src\u002Fcomponents\u002Fadditem\u002Fadditem.pug";
pug_html = pug_html + "\n\u003Cdiv" + (pug_attr("class", pug_classes([blockName + '__form'], [true]), false, false)) + "\u003E";
;pug_debug_line = 2;pug_debug_filename = "src\u002Fcomponents\u002Fadditem\u002Fadditem.pug";
pug_html = pug_html + "\n  \u003Cp\u003E";
;pug_debug_line = 2;pug_debug_filename = "src\u002Fcomponents\u002Fadditem\u002Fadditem.pug";
pug_html = pug_html + "Добавить элемент";
;pug_debug_line = 3;pug_debug_filename = "src\u002Fcomponents\u002Fadditem\u002Fadditem.pug";
if (targetTitle) {
;pug_debug_line = 4;pug_debug_filename = "src\u002Fcomponents\u002Fadditem\u002Fadditem.pug";
pug_html = pug_html + "\n    \u003Cmark\u003E";
;pug_debug_line = 4;pug_debug_filename = "src\u002Fcomponents\u002Fadditem\u002Fadditem.pug";
pug_html = pug_html + "в&nbsp; ";
;pug_debug_line = 5;pug_debug_filename = "src\u002Fcomponents\u002Fadditem\u002Fadditem.pug";
pug_html = pug_html + "\u003Ci\u003E";
;pug_debug_line = 5;pug_debug_filename = "src\u002Fcomponents\u002Fadditem\u002Fadditem.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = targetTitle + ': ') ? "" : pug_interp)) + "\u003C\u002Fi\u003E\u003C\u002Fmark\u003E";
}
pug_html = pug_html + "\n  \u003C\u002Fp\u003E";
;pug_debug_line = 6;pug_debug_filename = "src\u002Fcomponents\u002Fadditem\u002Fadditem.pug";
pug_html = pug_html + "\n  \u003Cinput type=\"text\" name=\"name\" placeholder=\"Название\" value=\"\"\u002F\u003E";
;pug_debug_line = 7;pug_debug_filename = "src\u002Fcomponents\u002Fadditem\u002Fadditem.pug";
pug_html = pug_html + "\n  \u003Cinput type=\"text\" name=\"url\" placeholder=\"http:\u002F\u002F..\" value=\"\"\u002F\u003E";
;pug_debug_line = 8;pug_debug_filename = "src\u002Fcomponents\u002Fadditem\u002Fadditem.pug";
